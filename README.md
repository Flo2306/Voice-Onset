...
- It can take quite some time as it is splitting the recording multiple times (a 5 second recording takes about 5 seconds to process, the algorithm has a complexity of log(n))
